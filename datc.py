...
class DATC_6_D_Quasi(DiplomacyAdjudicatorTestCase):
    ...
    def ptest_6D29_illegal_fail(self):
        ...
        self.legalOrder(TUR, [(TUR, AMY, BUL), SUP, (TUR, FLT, BLA), MTO, RUM])
        self.assertMapState(start_state)
    def ptest_6D30_illegal_fail(self):
